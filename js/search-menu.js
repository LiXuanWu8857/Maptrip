...
(function () {
  ...
  var CSS =
    ...
    // bottom＝safe-area-inset-bottom + 64：貼齊變高後底部列的上緣（底部列已含 safe-area）。
    // z-index:22 提到底部列(20)之上 → 就算貼著底部列也永遠在上、按得到。
    '#mt-sm{position:fixed;right:14px;bottom:calc(env(safe-area-inset-bottom, 0px) + 64px);z-index:22;' +
